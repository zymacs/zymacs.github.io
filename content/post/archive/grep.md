...
![grep_output](assets/img/grep_output.png)
...
Some special characters can't be comprehended even with extended regex so
you have to use -P. For instance, the special char for digits \d.

```sh
echo '292 abacus' | grep -P '\d{2}' 
```
