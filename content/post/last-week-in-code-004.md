...
I'd day that's imagining having your own broadcasting station and I made one step towards that when I set up streaming with [AzuraCast](https://www.azuracast.com/) last week. I think I mentioned this somewhere among the
...
- [Indie Radio](https://indieradio.keithnambale.com/radio.mp3)
...
Then the more interesting one is my sentiment on the lack of appreciation for scripting. The video I linked on scripting  I found after I was through with writing this article. But one could say I took some points straight
out of that video since it was published earlier than I posted this. Or, the protege effect. I thought it was just me, this feeling I had there was something special about teaching it should be
a studied phenomenon, only to learn it was. I guess what I am trying to say is, you can trust that I am a valuable independent thinker of sorts if you wonder who the hell I am. Trying to get me some credibility points is all :)_
